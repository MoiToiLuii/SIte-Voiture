...
<main>
    <div class="carte-confirmation">
        ...
        <div class="recap">
            ...
            <?php if (!empty($resa['prix_total'])): ?>
            <div class="recap-ligne" style="border-top: 2px solid #2ecc71; margin-top:8px; padding-top:8px;">
                <span class="label" style="font-weight:bold; color:#0A1931;">💰 Total estimé</span>
                <span class="valeur" style="font-size:18px; color:#2ecc71; font-weight:bold;"><?= $resa['prix_total'] ?> €</span>
            </div>
            <?php endif; ?>
